...
class AuthenticationError(AppError):
    ...
    def __init__(self, message: str, error_code: str = ErrorCode.AUTH_INVALID_CREDENTIALS, details: Optional[Dict] = None):
...
class ValidationError(AppError):
    ...
    def __init__(self, message: str, error_code: str = ErrorCode.DATA_VALIDATION_ERROR, details: Optional[Dict] = None):
