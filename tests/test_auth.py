...
class TestRegistration:
    ...
    @pytest.mark.asyncio
    async def test_register_duplicate_email(self, client: AsyncClient, test_user, factory):
...
class TestProtectedEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_access_with_valid_token(self, authenticated_client: AsyncClient, test_user):
